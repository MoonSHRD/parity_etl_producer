PKG = github.com/MoonSHRD/token_factory
...
.PHONY: all clean test lint deps proto fun

all: contracts

contracts: build/contracts/token_factory.0.0.1

build/contracts/token_factory.0.0.1: proto
	mkdir -p build/contracts
	go build -o $@ src/token_factory.go
...
cli:
	go build -o build/token_factory src/cli/main.go
